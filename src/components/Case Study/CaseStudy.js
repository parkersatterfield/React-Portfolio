...
const strikeNextSteps = 'The one critical step in this design process that I skipped was user interviews and feedback. Talking to golfers who would be considered the end user for an application like this is extremely important. Though I think the prototype looks great, I am not the only user - I am also the designer. One thing I need to keep in mind for UX designs is that I am not designing this app for me, I am designing for ALL end users.'
...
function CaseStudy() {  
    ...
    if (location === '/casestudy/strike') {
        ...
        projectNextSteps = strikeNextSteps;
    } else {
        return (
